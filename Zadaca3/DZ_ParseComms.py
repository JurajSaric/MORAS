# -*- coding: utf-8 -*-
"""
Created on Mon Dec 11 22:48:57 2023
...
def _parse_command(self, line, b, k):
    if line[0] == "@":
        num = int(line[1:])
        ...
        if op in self._op:
            ...
            self._flag = False
            self._line = k
            self._errm = "operation invalid " + op
        ...
        if dest in self._dest:
            ...
            self._flag = False
            self._line = k
            self._errm = "Destination invalid " + dest
